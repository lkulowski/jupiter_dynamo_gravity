...
Recently, the Juno spacecraft at Jupiter has measured the planet's gravity field with high precision. The gravity contribution from atmospheric zonal flows to Jupiter's gravity field have been studied in detail. If atmospheric zonal flows extend about 3,000 km deep, they can explain most of the structure of the observed gravity field that arises from the dynamics. The gravity contribution from zonal flows in the dynamo region, however, have not yet been investigated. Dynamo zonal flows may produce an large gravity signal. Although these flows are slow, they occupy most of the volume of the planet and resides in a region with a large background density. The slow motion of a large volume of dense fluid has the potential to produce a large gravity signal. 
